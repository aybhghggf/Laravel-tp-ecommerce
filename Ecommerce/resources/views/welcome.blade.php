...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        <a href="#home" class="nav-link text-gray-800 hover:text-amber-600 px-3 py-2 text-sm font-inter font-medium">
                            Home
                        </a>
                        <a href="#perfumes" class="nav-link text-gray-800 hover:text-amber-600 px-3 py-2 text-sm font-inter font-medium">
                            Perfumes
                        </a>
                        <a href="#about" class="nav-link text-gray-800 hover:text-amber-600 px-3 py-2 text-sm font-inter font-medium">
                            About
                        </a>
                    </div>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center space-x-4">
                        <button class="auth-btn text-gray-600 hover:text-gray-800 px-4 py-2 text-sm font-inter font-medium border border-gray-300 rounded-lg hover:bg-gray-50">
                            Sign In
                        </button>
                        <button class="auth-btn bg-gradient-to-r from-amber-500 to-amber-600 text-white px-4 py-2 text-sm font-inter font-medium rounded-lg hover:from-amber-600 hover:to-amber-700 shadow-md hover:shadow-lg">
                            Login
                        </button>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center">
            <h2 class="text-3xl font-playfair font-semibold text-gray-800 mb-4">
                Welcome to Essence
            </h2>
            <p class="text-gray-600 font-inter max-w-2xl mx-auto">
                Discover our exquisite collection of premium fragrances, crafted to perfection and designed to captivate your senses.
            </p>
        </div>
    </div>
</body>
